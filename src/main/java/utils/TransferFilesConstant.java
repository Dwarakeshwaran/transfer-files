...
public class TransferFilesConstant {

	private TransferFilesConstant() {
	}
	...
	public static final String SFTP_KEY_NAME = "key.pem";
	...
	public static final String FITTLE_SECRET = "FittleSecret";
	public static final String SFTP_USERNAME = "-username";
	public static final String SFTP_KEY = "-key";
